...
class HotineObliqueMercator(Projection):
    def __init__(self, central_longitude, central_latitude, scale_factor,
                 false_easting, false_northing, globe):
        proj4_params = [('proj', 'somerc'), ('lon_0', central_longitude),
                        ('lat_0', central_latitude), ('k_0', scale_factor),
...
class CH1903(HotineObliqueMercator):
    ...
    def __init__(self):
        ...
        super(CH1903, self).__init__(central_longitude=7.439583333333333,
